...
static void print_banner(void) {
    printf("\n");
#ifdef _WIN32
    /* Simple ASCII for Windows CMD compatibility */
    printf("   _  _______  __\n");
    printf("  / |/ / __/ |/_/\n");
    printf(" /    / _/_>  <  \n");
    printf("/_/|_/___/_/|_|  \n");
#else
    /* Colored ASCII for Linux/macOS/Modern Terminals */
...
#endif
    printf("\n");
    printf("  \033[90mGenerated by \033[0m\033[31mNex %s\033[0m\n", NEX_VERSION);
    printf("  \033[90mRun 'nex --help' for available commands.\033[0m\n");
    printf("\n");
}
