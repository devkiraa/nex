...
Download the latest release for your platform from the [Releases page](https://github.com/nexhq/nex/releases):
...
Runtime: Python >=3.6
Repository: https://github.com/nexhq/example-hello-world
